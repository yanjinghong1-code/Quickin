...
function updateGameMode() {
 ...
 $("#platform_PC, #platform_PS5, #platform_PS4, #platform_XSX, #platform_X1").show().addClass("selected")
        ...
        $("#Loc_ZM").show()
        $("#Loc_DMZ").hide()
        if($("#Loc_SP").hasClass("selected") || $("#Loc_DMZ").hasClass("selected")) {
            $("#Loc_SP").removeClass("selected")
            $("#Loc_DMZ").removeClass("selected")
...
if(label_select_val) {
 ...
 if(PROJECT == "REX" && platform == "PC/PS5/PS4/XSX/X1") display_platform = "PC/PS5/XSX"
    ...
    const platform_type = {
        ...
        "REX": {"All": "15785", "PC/PS5/PS4/XSX/X1": "10416", "PS4": "10417", "PS4 Pro": "10418", "PS5": "10419", "PS5 Pro": "34800", "XB3 Durango": "10420",
 ...
 if(rex_vals.length == 0) {
    ...
    const game_mode = {
    "REX": {
        "Global": "&customfield_10444=45259",
        "SP": "&customfield_10444=45254",
        "MP": "&customfield_10444=45255",
        "DMZ": "&customfield_10444=45258",
        "WZ": "&customfield_10444=45256"
    },
    "CHI": {
    ...
    else if(jira_labels.includes("Loc_DMZ")){ area = "DMZ" }
    ...
    const branch_type = {
        "REX": {"trunk": "31905", "release": "31907", "cert": "31908", "etu": "35601"},
...
const query_string = {
    "REX": "https://dev.activision.com/jira/secure/CreateIssueDetails!init.jspa?issuetype=10203&pid=10300" +
...
function getCommentPlatformList() {
 ...
 return bid.toString().startsWith("REX-") ? comment_platform_REX : comment_platform_CHI;
}
...
function updateComment() {
    ...
    const platform_list = getCommentPlatformList();
 const platform = platform_list[(platform_index % platform_list.length + platform_list.length) % platform_list.length];
    const lng = $("#bug_lng_select option:selected").text();
...
$(".comment").on("contextmenu", function (e) {
    ...
    if ($(this).hasClass("selected")) {
        const platform_list = getCommentPlatformList();
 platform_index = (platform_index + 1) % platform_list.length;
